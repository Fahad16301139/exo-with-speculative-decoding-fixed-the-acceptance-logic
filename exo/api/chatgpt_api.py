...
from exo.models import build_base_shard, build_full_shard, model_cards, get_repo, get_supported_models, get_pretty_name, get_tokenizer_repo
...
class ChatGPTAPI:
  ...
  async def handle_post_chat_token_encode(self, request):
    ...
    tokenizer = await resolve_tokenizer(get_tokenizer_repo(shard.model_id, self.inference_engine_classname))
