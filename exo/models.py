...
model_cards = {
  ...
  "llama-3.2-1b": {
    ...
    "repo": {
      ...
      "SpeculativeInferenceEngine": "unsloth/Llama-3.2-1B-Instruct",
    },
  ...
  "llama-3.2-3b": {
    ...
    "repo": {
       ...
       "SpeculativeInferenceEngine": "unsloth/Llama-3.2-3B-Instruct",
    },
  ...
  # small llama models for speculative decoding
  "JackFram/llama-160m": { 
    "layers": 12, 
    "repo": { 
      "TinygradDynamicShardInferenceEngine": "JackFram/llama-160m",
      "MLXDynamicShardInferenceEngine": "JackFram/llama-160m",
    }, 
  },
  "TinyLlama/TinyLlama-1.1B-Chat-v1.0": { 
    "layers": 22, 
    "repo": { 
      "TinygradDynamicShardInferenceEngine": "TinyLlama/TinyLlama-1.1B-Chat-v1.0",
      "MLXDynamicShardInferenceEngine": "TinyLlama/TinyLlama-1.1B-Chat-v1.0",
    }, 
  },
  # dummy
  "dummy": { "layers": 8, "repo": { "DummyInferenceEngine": "dummy", "SpeculativeInferenceEngine": "dummy" }, },
}
...
def get_tokenizer_repo(model_id: str, inference_engine_classname: str) -> Optional[str]:
  """Get the tokenizer repository, falling back to the main repo if no specific tokenizer repo is defined"""
  tokenizer_repo = model_cards.get(model_id, {}).get("tokenizer_repo", None)
  if tokenizer_repo:
    return tokenizer_repo
  return get_repo(model_id, inference_engine_classname)
